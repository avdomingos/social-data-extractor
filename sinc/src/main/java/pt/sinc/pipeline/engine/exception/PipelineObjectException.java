...
public class PipelineObjectException extends Throwable {
    private String message;
    private Exception innerException;

    public PipelineObjectException(String message) {
        this.message = message;
    }


    public PipelineObjectException(String message, Exception innerException) {
        this.message = message;
