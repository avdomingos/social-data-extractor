...
public class PipelineCancellationException extends PipelineException {

    public PipelineCancellationException(String message, Exception innerException, String methodName) {
        super(message, innerException, methodName);
    }

    public PipelineCancellationException(String message, Exception innerException) {
