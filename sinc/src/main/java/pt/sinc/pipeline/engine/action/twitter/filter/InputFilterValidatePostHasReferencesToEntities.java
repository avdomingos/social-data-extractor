...
public class InputFilterValidatePostHasReferencesToEntities extends InputFilterValidateUserExistsInData{
    public InputFilterValidatePostHasReferencesToEntities()
    {
        super();
        this.NODE_NAME_FOR_VALIDATION = "entities";
        this.EXCEPTION_NODE_NOT_FOUND = "No entities found";
    }
}
