...
public class LaunchApplicationException extends Throwable {
    public LaunchApplicationException(String message) {
        super(message);
    }
    public LaunchApplicationException(Throwable cause, String message) {
        super(message,cause);
    }
    public LaunchApplicationException(Throwable cause) {
        super(cause);
    }
}
