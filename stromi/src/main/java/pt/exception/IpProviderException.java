...
public class IpProviderException extends Exception{
    public IpProviderException(String message) {
        super(message);
    }
    public IpProviderException(Throwable cause, String message) {
        super(message,cause);
    }
    public IpProviderException(Throwable cause) {
        super(cause);
    }
}
