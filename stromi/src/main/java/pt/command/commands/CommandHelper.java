...
//
//
//@CommandAnnotation(command = "help", description = "Show all available commands", usage = "help")
//public class CommandHelper extends Command {
//
//    @Override
//    protected void commandAction(PrintStream ps, Map<String, String> parameters) {
//        ps.println("Available commands:");
//        for (String command : Commands.AvailableCommands.keySet()) {
//            ps.println(command);
//        }
//    }
//}
