...
package stratex.twitter.provider.exception;

import stratex.exceptions.StratexException;

public class ConnectorFactoryException extends StratexException {
    public ConnectorFactoryException(String message, Exception e) {
        super(message, e);
    }
}
