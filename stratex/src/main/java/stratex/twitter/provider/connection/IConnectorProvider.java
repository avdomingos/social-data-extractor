...
/**
 Interface defines the contract to connect to twitter's streaming API.
 This contract allows for an abstraction of the connection provider, allowing both for OAuth or
 Basic Authentication
*/

public interface IConnectorProvider<T extends ConnectorParameters> {
    HttpRequestBase getConnector(T connectorParameters) throws ConnectionProviderException;
}
