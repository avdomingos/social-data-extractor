...
package stratex.twitter.provider.auth.exception;


import stratex.exceptions.StratexException;

public class ConnectionProviderException extends StratexException {

    public ConnectionProviderException(String message, Exception e) {
        super(message, e);
    }
}
